...
interface OtherUser { id: string; name: string; avatar?: string; }
...
export default function MessagesPage() {
  ...
  const sendMsg = async () => {
    ...
    try {
      ...
      setConvs(prev => prev.map(c =>
        c.other.id === active.conv.other.id
          ? { ...c, lastMessage: { content: text.trim(), createdAt: data.createdAt, isRead: true, isMine: true } }
          : c
      ));
      setText('');
    } finally {
